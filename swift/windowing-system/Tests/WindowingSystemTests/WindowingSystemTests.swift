...
@Suite struct WindowingSystemTests {
  ...
  @Test("Initialzer accepts all input")
  func testMainWindow() {
  ...
  @Test("Initialzer accepts all input except contents")
  ...
  @Test("Initialzer accepts all input except size")
  ...
  @Test("Initialzer accepts all input except position")
  ...
  @Test("Initialzer accepts no position and no size")
